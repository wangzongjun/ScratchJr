...
import {gn, newHTML, setCanvasSize, isTablet, getIdFor, isAndroid, setProps, hitRect, frame, onTouchStartBind, onTouchMoveBind, onTouchEndBind} from '../utils/lib';
...
export default class Paint {
    ...
    static createSizeSelector (pal) {
        ...
        for (var i = 0; i < pensizes.length; i++) {
            ...
            ps.key = i;
            onTouchStartBind(ps,function (e) {
                e.preventDefault();
                e.stopPropagation();
