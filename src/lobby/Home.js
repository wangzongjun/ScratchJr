...
import {gn, newHTML, isTablet, onTouchStartBind, onTouchMoveBind, onTouchEndBind} from '../utils/lib';
...
export default class Home {
    static init () {
        ...
        onTouchStartBind(frame,Home.handleTouchStart);
        onTouchEndBind(frame,Home.handleTouchEnd);
    ...
    static handleTouchStart (e) {
        ...
        function holdit () {
            onTouchMoveBind(frame,Home.handleMove);
            var repeat = function () {
