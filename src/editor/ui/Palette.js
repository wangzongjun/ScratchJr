...
import {frame, gn, localx, newHTML, scaleMultiplier, isTablet, newDiv,
    ...
    setCanvasSize, hitRect, writeText, getStringSize,onTouchStartBind,onTouchEndBind} from '../../utils/lib';
...
export default class Palette {
    ...
    static setup (parent) {
        ...
        onTouchStartBind(div,function (evt) {
    ...
    static drawRecordSound (w, h, dx) {
        ...
        onTouchStartBind(div,Palette.recordSound);
    }
